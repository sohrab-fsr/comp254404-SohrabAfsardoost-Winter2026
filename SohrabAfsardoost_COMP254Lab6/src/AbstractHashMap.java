...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  private double maxLoad;              // maximum allowed load factor
  ...
  /** Creates a hash table with given capacity, default prime, and load factor. */
  public AbstractHashMap(int cap, double load) { this(cap, 109345121, load); }
