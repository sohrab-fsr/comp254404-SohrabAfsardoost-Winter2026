...
public class ChainHashMap<K,V> extends AbstractHashMap<K,V> {
  ...
  /** Creates a hash table with given capacity and load factor. */
  public ChainHashMap(int cap, double load) { super(cap, load); }
  ...
  public ChainHashMap(int cap, int p, double load) { super(cap, p, load); }
