...
public class DoublyLinkedList<E> {
  ...
  /**
   * Exercise 1 (Lab 2):
   * Concatenate two doubly linked lists L (this list) and M (parameter),
   * both with header/trailer sentinels, into a single list L' stored in L.
   * After concatenation, M becomes empty.
   *
   * Hint: Connect the end of L into the beginning of M.
   */
  public void concatenate(DoublyLinkedList<E> M) {
    ...
    if (this.isEmpty()) {
      // L is empty => copy the whole chain of M into L by relinking sentinels
...
//main method
  public static void main(String[] args) {
    ...
    // L' will be stored in L (M becomes empty)
    L.concatenate(M);

    System.out.println("\nAfter concatenate:");
    System.out.println("L' = " + L);
    System.out.println("M  = " + M + "  (should be empty)");
  }
